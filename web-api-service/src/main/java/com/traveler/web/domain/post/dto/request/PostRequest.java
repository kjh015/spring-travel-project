package com.traveler.web.domain.post.dto.request;
...
public final class PostRequest {
    ...
    public record CreateDTO(
            ...
            @NotNull(message = "카테고리는 필수입니다.") @Schema(description = "카테고리", example = "FOOD") PostCategory category,
            @NotNull(message = "지역은 필수입니다.") @Schema(description = "지역", example = "GYEONGGI") PostRegion region,
