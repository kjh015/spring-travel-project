...
public class DeduplicationRuleQueryService {
    ...
    public PageResponse<DeduplicationRuleResponse.ListDTO> getDeduplicationRules(Long logProcessId, Pageable pageable) {
        ...
        Page<DeduplicationRule> deduplicationRule =
                deduplicationRuleRepository.findByLogProcessId(logProcessId, pageable);

        return PageConverter.toPageResponse(deduplicationRule, deduplicationRuleMapper::toListDTO);
    }

    public DeduplicationRuleResponse.DetailDTO getDeduplicationRule(Long deduplicationRuleId) {
        ...
        return deduplicationRuleMapper.toDetailDTO(deduplicationRule);
    }
}
