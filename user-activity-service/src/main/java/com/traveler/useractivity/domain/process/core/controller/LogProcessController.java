package com.traveler.useractivity.domain.process.core.controller;
...
import com.traveler.useractivity.domain.process.core.service.command.LogProcessCommandService;
import com.traveler.useractivity.domain.process.core.service.query.LogProcessQueryService;
...
@RequestMapping("/v1/log-processes")
